...
export default function AccordCreator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#06070a] via-[#071022] to-[#0b0f13] text-white p-6 pt-24">
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          <h1 className="text-5xl font-bold mb-3 tracking-tight">Accord Creator</h1>
          <p className="text-slate-400 text-lg">Build and discover fragrance layering combos</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-4">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold">Layer Your Bottles</h2>
              <button
                onClick={loadPreset}
                className="px-6 py-2.5 bg-amber-400 hover:bg-amber-300 text-slate-900 rounded-full text-sm font-bold tracking-widest uppercase transition shadow-lg"
              >
                Load Example
              </button>
            </div>
